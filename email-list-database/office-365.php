...
<div class="jumbotron jumbotron--list-detail jumbotron--regular-bg">
    <div class="container jumbotron--list-detail__container table-layout-fixed">
        <div class="jumbotron--list-detail__col-half jumbotron--list-detail__col-left">
            <img class="img-responsive" src="<?= $siteUrl; ?>bundles/bydhome/img/thumbs/contact-list2.jpg" alt="mailerstation">
        ...
        <div class="jumbotron--list-detail__col-half jumbotron--list-detail__col-right">
            ...
            <div class="gap-bottom-small">
                <h1 class="jumbotron__title" style="margin-top: 15px;">Office 365 EMAIL LIST</h1>
            ...
            <div class="gap-bottom">
                ...
                <h4 class="jumbotron__title">Custom Order E-mail: <span id="demo" class="jumbotron--list-detail__price" style="color: orange"><?php $totalemail = 48737; echo number_format($totalemail); ?></span></h4>
            ...
            <p class="text-loblolly">Yes, you can get the direct contact information of chief executive officers! Pull a huge, human-verified contact list of Office 365 emails and start leveraging that data as part of your marketing outreach. With this pre-built Office 365 database, you can jump to the top with direct and accurate email addresses that will energize your next B2B marketing campaign.</p>
            <div class="gap-bottom-medium hidden-tlnd">
                <form action="<?= $siteUrl; ?>checkout/step1" method="POST">
                    ...
                    <input type="hidden" name="emailCategory" value="Office 365">
                    <input type="hidden" name="selectItem" value="Office 365" >
                    <input type="hidden" name="totalemail" value="48737" >
    ...
    <div class="container">
        <div class="row gap-bottom-large">
            <div class="col-md-10 col-md-offset-1">
                <h2 class="primary-title h3">Office 365 </h2>
                <p style="text-align: justify;">Chief executive officers (Office 365) are the most important people in a company. They lead, manage, coordinate, and are responsible for big managerial decisions. If you want to network with the people who have the power and authority to actually make important decisions, then this premium Office 365 email list is for you. It's simply how to contact Office 365 with direct marketing. Too often, smaller companies and start-ups are forced to talk with people who don't have the power to make changes. If you want your business-to-business (B2B) marketing campaign to be successful, you need an accurate, targeted list of actionable sales leads. These heads of companies are the people to talk to; they can make changes and initiate key business relationships.</p><p><br><br>In this ready-to-download contact list, you can find an organized directory of Office 365 phone numbers, emails, and names across companies and institutions. mailerstation.com offers this verified <a href="https://blog.mailerstation.com/5-ways-to-increase-your-return-on-ceo-email-addresses" target="_blank">Office 365 database</a> at an amazingly affordable price while still maintaining accuracy. Use our targeted lists to contact leads who also happen to be the most important group of leaders in the corporate world.</p><p><br><br>With this pre-built Office 365 mailing list, your marketing efforts will be more effective because you'll be connecting with businesses' top decision-makers. Buy our real, valuable sales leads and find Office 365 email addresses online right now, or continue to narrow your audience to your industry or area with our list-builder tool. Connect with real decision-makers by reaching to the top of the corporate ladder. Pull a list of Office 365 email addresses today!</p><p>
                    
                    <!--<strong><br>Resources: <a href="http://hbswk.hbs.edu/item/what-ceos-do-and-how-they-can-do-it-better">What Office 365 Do</a>, <a href="http://www.ceo.com/">Office 365 News</a>, <a href="http://www.theceomagazine.com/">Office 365 Magazine</a> - Edited by <a href="https://www.mailerstation.com/leadership/gary-taylor">Gary Taylor</a> Other articles by Gary Taylor <a href="https://www.mailerstation.com/computers-changed-history">Computer History</a>, <a href="https://www.mailerstation.com/tips-for-successful-online-business">Business Online</a><a href="https://www.mailerstation.com/leadership/gary-taylor"></a></strong>-->
                    </p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p><p>Our data is verified weekly. We have developed a complex algorithm for this purpose. With this algorithm, we check the accuracy levels of our data against millions of sources and apply necessary updates.</p></p>
            </div>
            <div class="col-md-6">
                <h4>How long does it take to get my email list after I order online?</h4>
                <p><p>You can instantly download your database after your order is confirmed.</p></p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <h4>I want to place an order, but I have doubts about the accuracy of the data. Why should I trust you?</h4>
                <p><p>All of the records we sell have a 95% accuracy guarantee. If you encounter a lower accuracy rate, you can contact our customer relations staff and we will provide you new data for free to make up the difference. We call it our Bounce-Back Guarantee.</p></p>
            </div>
            <div class="col-md-6">
