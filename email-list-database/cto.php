    ...
    <div class="container jumbotron--list-detail__container table-layout-fixed">
        ...
        <div class="jumbotron--list-detail__col-half jumbotron--list-detail__col-right">
            ...
            <div class="gap-bottom-small">
                <h1 class="jumbotron__title" style="margin-top: 15px;">CIO, CTO EMAIL LIST</h1>
            ...
            <div class="gap-bottom">
                ...
                <h4 class="jumbotron__title">Custom Order E-mail: <span id="demo" class="jumbotron--list-detail__price" style="color: orange"><?php $totalemail = 24441; echo number_format($totalemail); ?></span></h4>
...
<div class="section">
   <div class="container">
      <h2 class="primary-title">FAQ Regarding to CIO, CTO Email List</h2>
      <div class="row">
         <div class="col-md-6">
            <h3>Should I order all of your records or can I order any amounts that I want?</h3>
            <p></p>
            <p>Yes! You can order any size email list based on your needs and budget, using our online tool. Just use the search filters to narrow down your target audience and then select the size of your list. It's that simple!</p>
            <p></p>
         </div>
         <div class="col-md-6">
            <h3>Can you send free sample data for your CTO email list?</h3>
            <p></p>
            <p>Yes, you can download a sample of the CTO and CIO email list by clicking on the "Download Sample" link directly. This will allow you to see if the data is right for you before buying.</p>
            <p></p>
         </div>
      </div>
      <div class="row">
         <div class="col-md-6">
            <h3>Is your CTO business email list for the USA only?</h3>
            <p></p>
            <p>
               Absolutely not! Bookyourdata allows you to build a targeted email list in seconds. The <a href="#">B2B database</a> is available not only from the US but from 170+ countries worldwide! So whether you're marketing cloud software or a hardware solution, we have the IT contacts you need to reach out to in order to make sales in different parts of the world. Start building your B2B database today and expand your international network!
            </p>
            <p></p>
         </div>
         <div class="col-md-6">
            <h3>Does your CIO email list include generic emails or direct?</h3>
            <p></p>
            <p>Our database has only direct email addresses, we don't sell any generic emails. We want you to succeed in your email marketing campaign, and that means having the right information. We make it our mission to provide you with accurate, up-to-date data that are well-organized and easy to use.</p>
            <p></p>
         </div>
      </div>
   </div>
         ...
         <div class="col-md-6">
            <div class="testimonial text-left">
               <h6 class="secondary-title">
                  Gerard Christiansen - Global Advertising
               </h6>
               <p><em>"Hey Everyone! I wanted to share with you my experience with Bookyourdata. I was trying to grow my business and needed a way to find CTOs or CIOs in Canada but I wasn't sure how to find them. I used the bookyourdata email list and it was so easy! It's super simple. You just select what you're looking and it pulls up an email list in seconds. I felt like a genius! But the best part is that it actually worked: my company has grown more than 30% since using their service."</em></p>
            </div>
         </div>
         <div class="col-md-6">
            <div class="testimonial text-left">
               ...
               <p><em>"I was really in a rut. My marketing team kept telling me I needed to expand my company's reach, but I couldn't seem to get them working together. I had some great ideas for how to promote our product, but getting the right people on board with those ideas was proving impossible and frustrating. One of my friends told me about BookYourData, and I thought… why not? The price seemed reasonable, and the service was easy to use, so I just went for it. It seemed totally worth a try, even if it didn't pan out. But I'm so glad it did! The data helped my team come up with new ways to reach our customers. The list of CTOs and CIOs from BookYourData helped us build the perfect targeted email list that got traction with the right people. People who make real decisions about technology purchases. Now we don't have to worry about making connections with technical decision-makers; we already have them! "</em></p>
            </div>
         </div>
      </div>
   </div>
