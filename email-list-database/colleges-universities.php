<?php include_once '../assets/php/header.php'; $_SESSION['myPrice'] = 11262;$siteUrl = 'https://emailbigdata.com/';?>
    ...
    <div class="container jumbotron--list-detail__container
        ...
        <div class="jumbotron--list-detail__col-half
            ...
            <div class="gap-bottom-small">
                <h1 class="jumbotron__title" style="margin-top: 15px;">Colleges Universities EMAIL
                    LIST</h1>
            ...
            <div class="gap-bottom">
                ...
                <h4 class="jumbotron__title">Custom Order E-mail: <span id="demo" class="jumbotron--list-detail__price" style="color: orange"><?php $totalemail = 187706; echo number_format($totalemail); ?></span></h4>
            ...
            <p class="text-loblolly">Colleges and universities can be
                contacted today with the help of our pre-built list of
                college emails and contact directory! Buy a college
                email database containing direct emails, phone numbers,
                and more and get in touch with administrators and
                decision-makers in higher education now!</p>
            <div class="gap-bottom-medium hidden-tlnd">
                <form action="<?= $siteUrl; ?>checkout/step1" method="POST">
                    ...
                    <input type="hidden" name="selectItem" value="Collecges universities" >
                    <input type="hidden" name="totalemail" value="187706" >
    ...
    <div class="container">
        <div class="row gap-bottom-large">
            <div class="col-md-10 col-md-offset-1">
                <h2 class="primary-title h3">Colleges Universities </h2>
                <p style="text-align: justify;">Find college administrators, professors, department
                    heads, and key decision-makers with the help of this
                    university email database. Colleges and
                    universities, public and private, have a lot of
                    influence, not only on their students, but on their
                    communities. To start talking to the key points of
                    contact at numerous higher education institutions,
                    simply download this verified university email list.
                    College mailing lists like this rarely double as
                    directories of non-generic email addresses, as well
                    as accurate phone directories. With one organized
                    university mailing list from mailerstation.com, you
                    can get in touch with your target audience in many
                    different ways, as it includes all of the important
                    contact information: emails, phone numbers,
                    addresses, titles, and more. <br> <br>Our college
                    email list can be pulled right into your CRM. With
                    mailerstation.com's university email address list,
                    you can find the highly qualified people who would
                    be most interested in your product and start
                    marketing to them right away. In a few minutes, use
                    this college email address list to call or email
                    leads who are influential with the group your
                    business needs to reach. <br> <br>This affordable
                    college mailing list is for those looking to market
                    their product or service to colleges and
                    universities, whether that item be synthetic turf
                    for a stadium, a new line of textbooks, research
                    equipment, or something else that's relevant to
                    those in higher education. Our premium mailing list
                    for colleges enables you to directly contact
                    professors and administrators who may be interested
                    in your product. <br> <br>Download it and start
                    connecting with your target B2B audience:
                    professionals working at a university or college.
                    Mail list options can also be crafted by using our
                    build-a-list tool. Build your own, customized list
                    of targeted sales leads or purchase this
                    ready-to-download data product now! </p>
            </div>
        </div>
