    ...
    <div class="container jumbotron__container">
        <div class="jumbotron__inner">
            <div class="row">
                ...
                <div class="col-md-6">
                    These pre-made lists are our ready-to-download
                    directories, full of the most useful contacts
                    in many types of industries. You can find a wide
                    variety of accurate, verified lists that will
                    help you reach out to your target group. Find your
                    audience now!
                </div>
            </div>
        </div>
            ...
            <li class="list__item gap-bottom-medium">
                <div class="box box--medium-pad shadow-primary">
                    ...
                    <p>Do you know what the most important part of a B2B
                        ...
                        accurate contact information for people who have
                        the power to make decisions. Don&#039;t waste
            ...
            <li class="list__item gap-bottom-medium">
                <div class="box box--medium-pad shadow-primary">
                    ...
                    <p>Network with people in departments that are most
                        ...
                        that be HR, management, or any of the
                        departments listed below. Market to those in
            ...
            <li class="list__item gap-bottom-medium">
                <div class="box box--medium-pad shadow-primary">
                    ...
                    <p>Connect with the right people with our
                        ...
                        accurate, and market to businesses in relevant
                        industries, such as hospitality, construction,
                        marketing, or any of the industries listed
            ...
            <li class="list__item gap-bottom-medium">
                <div class="box box--medium-pad shadow-primary">
                    ...
                    <p>Pull reliable, accurate international email lists
                        ...
                        conduct business overseas by helping you find
                        companies&#039; emails, phone numbers, and more.
            ...
            <li class="list__item gap-bottom-medium">
                <div class="box box--medium-pad shadow-primary">
                    ...
                    <p>Looking for direct email contacts of executives,
                        ...
                        the only one that can fill your marketing needs
