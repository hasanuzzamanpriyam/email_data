...
<main class="pad-bottom-medium">
    <div class="container regular-page-content
        ...
        <div class="premade-lists gap-bottom-small">
            ...
            $output = '';
            $allJobLevel = $user->all_zoom_info();
            if ($allJobLevel) {
...
<script>
    ...
    function displayZoomInfo() {
        $.ajax({
            ...
            type: 'post',
            data: {
                action: 'display-total-zoom-info'
            },
            success: function(response) {
                $("#totalZoomInfo").html(response);
            }
        });
    }
</script>