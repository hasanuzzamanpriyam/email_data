            ...
            <div class="row">
                <div class="col-md-6 gap-bottom-tld">
                    ...
                    <div class="breadbrumb">
                        ...
                        <span class="breadbrumb__item">International</span>
                    </div>
                </div>
                <div class="col-md-6">
...
<main class="pad-bottom-medium">
    <div class="container regular-page-content
        ...
        <?php 
            ...
            $output = '';
            $allJobLevel = $user->all_international();
            if ($allJobLevel) {
...
<script>
    ...
    function displayTotalInternational() {
        $.ajax({
            url: '../assets/php/action',
            type: 'post',
            data: {
                action: 'display-total-international'
            },
            success: function (response) {
                $("#totalInternational").html(response);
            }
        });
    }
</script>