            ...
            <div class="row">
                <div class="col-md-6 gap-bottom-tld">
                    ...
                    <div class="breadbrumb">
                        ...
                        <span class="breadbrumb__item">Industries</span>
                    </div>
                </div>
                <div class="col-md-6">
...
<main class="pad-bottom-medium">
    <div class="container regular-page-content
        ...
        <div class="premade-lists gap-bottom-small">
            ...
            $output = '';
            $allJobLevel = $user->all_industries();
            if ($allJobLevel) {
...
<script>
    displayTotalJobIndustries();

    function displayTotalJobIndustries() {
        $.ajax({
            url: '../assets/php/action',
            type: 'post',
            data: {
                action: 'display-total-industries'
            },
            success: function(response) {
                $("#totalIndustries").html(response);
            }
        });
    }
</script>