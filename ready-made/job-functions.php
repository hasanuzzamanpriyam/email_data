            ...
            <div class="row">
                <div class="col-md-6 gap-bottom-tld">
                    ...
                    <div class="breadbrumb">
                        ...
                        <span class="breadbrumb__item">Job Functions</span>
                    </div>
                </div>
                <div class="col-md-6">
...
<main class="pad-bottom-medium">
    <div class="container regular-page-content
        ...
        <div class="premade-lists gap-bottom-small">
            ...
            $output = '';
            $allJobLevel = $user->all_job_function();
            if ($allJobLevel) {
...
<script>
    displayTotalJobFunction();

    function displayTotalJobFunction() {
        $.ajax({
            url: '../assets/php/action',
            type: 'post',
            data: {
                action: 'display-total-job-function'
            },
            success: function(response) {
                $("#totalJobFunction").html(response);
            }
        });
    }
</script>