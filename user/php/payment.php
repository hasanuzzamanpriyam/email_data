...
define('PAYPAL_RETURN_URL', 'https://mailerstation.com/user/top_success');

define('PAYPAL_CANCEL_URL', 'https://mailerstation.com/user/top_cancel');

define('PAYPAL_NOTIFY_URL', 'https://mailerstation.com/user/ipn');
...
<?php } else if ($payMethod === 'Perfectmoney(USD)') { ?>
    <div>
        <form action="https://perfectmoney.com/api/step1.asp" method="post" class="form payment-form no-loading"
            ...
            <input type="hidden" name="PAYMENT_URL" value="https://mailerstation.com/user/top_success">
            <input type="hidden" name="PAYMENT_URL_METHOD" value="POST">
            <input type="hidden" name="NOPAYMENT_URL" value="https://mailerstation.com/user/top_cancel">
...
<?php } else if ($payMethod === 'Skrill') { ?>
    <div>
        <form action="https://pay.skrill.com" method="post" >
            ...
            <input type="hidden" name="transaction_id" value="<?php echo $topupCode; ?>">
            <input type="hidden" name="return_url" value="https://mailerstation.com/user/top_success">
            <input type="hidden" name="cancel_url" value="https://mailerstation.com/user/top_cancel">
