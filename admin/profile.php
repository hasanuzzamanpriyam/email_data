                        ...
                        <!-- Profile Tab Content Start -->
                            <div class="tab-pane container active" id="profile">
                                ...
                                <div class="card-deck">
                                    ...
                                    <div class="card border-primary align-self-center">
                                        <?php if(!$cphoto):?>
                                        <img src="assets/img/male.png" alt="" class="img-thumbnail img-fluid align-self-center" width="408px">
                                        <?php else:?>
                                            <img src="<?= 'assets/php/'.$cphoto; ?>" alt="" class="img-thumbnail img-fluid align-self-center" width="408px" >
                                        <?php endif;?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane container fade" id="changePass">
                                ...
                                <div class="card-deck">
                                    ...
                                    <img src="assets/img/pass.png" alt="" class="img-thumbnail img-fluid align-self-center" width="408px">
                                    </div>
                                </div>
                            </div>
