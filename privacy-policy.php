    ...
    <div class="container jumbotron__container">
        <div class="jumbotron__inner">
            ...
            <div class="breadbrumb">
                ...
                <span class="breadbrumb__item">Privacy Policy</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row gap-bottom-large">
            <div class="col-md-12">
                ...
                <p>
                    This Privacy Policy and Data Processing Principles <b>(“Privacy Policy”)</b> in our company websites
                    <b>(“Websites”)</b> are also reviewed in accordance with General Data Protection Regulation (“GDPR”)
                ...
                <b>1. Data Processing Principles</b>
                <p>
                    <b>a. Information Automatically Collected.</b>
                    ...
                    and other apps that you have downloaded <b>("Technical Data")</b>.
                </p>
                <p>
                    <b>b. Location Data.</b>
                ...
                <p>
                    <b>c. Information Provided by Others.</b>
                ...
                <p>Where you do not provide the personal data, we may not be able to provide you the related services; as it may depend on this information.</p>
                <b>2. How & What Personal Information We Collect and How We Use:</b>
                <p>
                ...
                <ul>
                    ...
                    <li>Job Title</li>
                    <li>Business Phone Numbers (general and direct)</li>
                    <li>Business Office Address</li>
                    <li>Public Social Link</li>
                </ul>
                <b>How and Where We Collect:</b>
                <ul>
                    <li>Public Information either publicized by you or by a 3rd party that you have authorized</li>
                    <li>Directly and indirectly from user activity on our Website</li>
                </ul>
                <b>How and Why We Use:</b>
                <ul>
                    <li>
                    ...
                    <li>Enabling you to interact with features or tools on our platform such as live chat;</li>
                    <li>Providing you our existing and new services,</li>
                    <li>Improving your user experience and our features;</li>
                </ul>
                <p>
                ...
                <p>Besides, in line with the aforementioned, we may also use your personal data in the following circumstances:</p>
                <ul>
                    <li>
                ...
                <b>3. Withdrawing your Consent or Request of Deletion</b>
                
                <b>4. Marketing Purposes and Newsletter</b>
                <p>
                ...
                <b>5. Disclosure of Your Information to Other Third Parties only if necessary</b>
                <p>We may have to share your personal data with the parties in the needed situations as set out below;</p>
                <ul>
                    <li>
                    ...
                    <li>Advertising networks and technology companies that measure advertising performance and attribution.</li>
                    <li>
                    ...
                    <li>
                        ...
                        do this, your data will be governed by the privacy policy of that social network.
                    </li>
                    <li>
                ...
                <b>9. Your Rights under GDPR and under CCPA</b>
                <p>You may have certain rights under GDPR in relation to your personal data. You have the rights to:</p>
                <ul>
                    <li>
                ...
                <p>If you wish to exercise any of these rights, you can contact us from our Websites.</p>
                <b>Your Rights Under CCPA;</b>
                <p>The CCPA provides California residents the following specific rights regarding processing their personal information;</p>
                <b>Access to Specific Information and Data Portability Rights</b>
                <p>As a Californian resident; you have the right to request the following;</p>
                <ul>
                    <li>The categories of personal information we collected about you</li>
                    <li>The categories of sources for the personal information we collected</li>
                    <li>Our business or commercial purpose for collecting or selling that personal information,</li>
                    <li>The categories of third parties with whom we share that personal information,</li>
                    <li>The specific pieces of personal information we collected about you (also called a data portability request).</li>
                </ul>
                <b>Deletion Request Rights:</b>
                <p>You have the right to request us to delete any of your personal data that we process have with some exceptions.</p>
                <p>
                ...
                <b>Right to Opt-Out of Sale or Sharing of Personal Information:</b>
                <p>
                ...
                <b>10. Cookies and Similar Tracking Technics</b>
                <ol type="a">
                    <li>
                    ...
                    <li>
                        ...
                        that if you choose to refuse cookies you may not be able to use the full functionality of the
                ...
                <b>12. Our Policy Towards Children</b>
                <p>
                ...
                <p>
                    ...
                    time to time. Accordingly, we may update this Privacy Policy and so you should review this page
                    periodically. If we make material changes to this Privacy Policy, we will update the "last updated"
                    data at the start of this Privacy Policy. Changes to this Privacy Policy are effective when they
                ...
                <b>15. Contact Details</b>
                <p>
                    Questions, comments and requests regarding this Privacy Policy are welcome and should be sent to:
                    <a href="mailto:support@emailbigdata.com" target="_blank"><span class="__cf_email__">[email&#160;protected]</span></a>
                </p>
            </div>
        </div>
    </div>
