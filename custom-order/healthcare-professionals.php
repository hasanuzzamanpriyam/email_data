...
if(isset($_POST['healthCareBtn'])){
  if(!empty($_POST['healthTechno'])){
    foreach($_POST['healthTechno'] as $selected){
      $_SESSION['selectItemHealth'][] = array(
        'id' => rand(100,10000),
        'emailCategory' => $_POST['healthCare'],
        'itemname' => $selected
      );
    }
  }
...
if(isset($_SESSION['selectItemHealth'])){
    if(isset($_GET['remove'])){
      $id = $_GET['id'];
      foreach($_SESSION['selectItemHealth'] as $key => $del){
        if($id == $del['id']){
          unset($_SESSION['selectItemHealth'][$key]);
        }
      }
    }
}
            ...
            <div class="box box--info gap-bottom categoryStyle">
                <div class="row" style="text-align: center;">
                    <div class="col-lg-12 gap-bottom-small-tlnd">
                        <h2 class="secondary-title clear-gap-vertical font-medium">Complete Your Order Specific Category for Healthcare Professionals</h2>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 40px;">
                <div class="main-title">
                    <h1 style="font-weight: 600; font-size: 25px; color: green;">HEALTHCARE PROFESSIONALS</h1>
                </div>
                <hr>
                <div class="col-sm-5">
                    <div class="row">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                ...
                                                <div class="main-order-item">
                                                    <div class="row">
                                                        ...
                                                        <form action="" method="POST">
                                                            <input type="hidden" name="healthCare" value="Industry" >
                                                            <input type="hidden" name="healthCategory" value="Health" >
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Accounting">
                                                                    <label for="">Accounting</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Airlines/Aviation">
                                                                    <label for="">Airlines/Aviation</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Alternative Dispute Resolution">
                                                                    <label for="">Alternative Dispute Resolution</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Alternative Medicine">
                                                                    <label for="">Alternative Medicine</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Animation">
                                                                    <label for="">Animation</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Apparel & Fashion">
                                                                    <label for="">Apparel & Fashion</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Architecture & Planning">
                                                                    <label for="">Architecture & Planning</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Arts & Crafts">
                                                                    <label for="">Arts & Crafts</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Automotive">
                                                                    <label for="">Automotive</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Aviation & Aerospace">
                                                                    <label for="">Aviation & Aerospace</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Banking">
                                                                    <label for="">Banking</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Biotechnology">
                                                                    <label for="">Biotechnology</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Broadcast Media">
                                                                    <label for="">Broadcast Media</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Building Materials">
                                                                    <label for="">Building Materials</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Business Supplies & Equipment">
                                                                    <label for="">Business Supplies & Equipment</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Capital Markets">
                                                                    <label for="">Capital Markets</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Chemicals">
                                                                    <label for="">Chemicals</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Civic & Social Organization">
                                                                    <label for="">Civic & Social Organization</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Civil Engineering">
                                                                    <label for="">Civil Engineering</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Commercial Real Estate">
                                                                    <label for="">Commercial Real Estate</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Computer & Network Security">
                                                                    <label for="">Computer & Network Security</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Computer Games">
                                                                    <label for="">Computer Games</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Computer Hardware">
                                                                    <label for="">Computer Hardware</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Computer Networking">
                                                                    <label for="">Computer Networking</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Computer Software">
                                                                    <label for="">Computer Software</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Construction">
                                                                    <label for="">Construction</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Consumer Electronics">
                                                                    <label for="">Consumer Electronics</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Consumer Goods">
                                                                    <label for="">Consumer Goods</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Consumer Services">
                                                                    <label for="">Consumer Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Cosmetics">
                                                                    <label for="">Cosmetics</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Dairy">
                                                                    <label for="">Dairy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Defense & Space">
                                                                    <label for="">Defense & Space</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Design">
                                                                    <label for="">Design</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Education Management">
                                                                    <label for="">Education Management</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="E-learning">
                                                                    <label for="">E-learning</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Electrical & Electronic Manufacturing">
                                                                    <label for="">Electrical & Electronic Manufacturing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Entertainment">
                                                                    <label for="">Entertainment</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Environmental Services">
                                                                    <label for="">Environmental Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Events Services">
                                                                    <label for="">Events Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Executive Office">
                                                                    <label for="">Executive Office</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Facilities Services">
                                                                    <label for="">Facilities Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Farming">
                                                                    <label for="">Farming</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Financial Services">
                                                                    <label for="">Financial Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Fine Art">
                                                                    <label for="">Fine Art</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Fishery">
                                                                    <label for="">Fishery</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Food & Beverages">
                                                                    <label for="">Food & Beverages</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Food Production">
                                                                    <label for="">Food Production</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Fundraising">
                                                                    <label for="">Fundraising</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Furniture">
                                                                    <label for="">Furniture</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Gambling & Casinos">
                                                                    <label for="">Gambling & Casinos</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Glass, Ceramics & Concrete">
                                                                    <label for="">Glass, Ceramics & Concrete</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Government Administration">
                                                                    <label for="">Government Administration</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Government Relations">
                                                                    <label for="">Government Relations</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Graphic Design">
                                                                    <label for="">Graphic Design</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Health, Wellness & Fitness">
                                                                    <label for="">Health, Wellness & Fitness</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Higher Education">
                                                                    <label for="">Higher Education</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Hospital & Health Care">
                                                                    <label for="">Hospital & Health Care</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Hospitality">
                                                                    <label for="">Hospitality</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Human Resources">
                                                                    <label for="">Human Resources</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Import & Export">
                                                                    <label for="">Import & Export</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Individual & Family Services">
                                                                    <label for="">Individual & Family Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Industrial Automation">
                                                                    <label for="">Industrial Automation</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Information Services">
                                                                    <label for="">Information Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Information Technology & Services">
                                                                    <label for="">Information Technology & Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Insurance">
                                                                    <label for="">Insurance</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="International Affairs">
                                                                    <label for="">International Affairs</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="International Trade & Development">
                                                                    <label for="">International Trade & Development</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Internet">
                                                                    <label for="">Internet</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Investment Banking/Venture">
                                                                    <label for="">Investment Banking/Venture</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Investment Management">
                                                                    <label for="">Investment Management</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Judiciary">
                                                                    <label for="">Judiciary</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Law Enforcement">
                                                                    <label for="">Law Enforcement</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Law Practice">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Legislative Office">
                                                                    <label for="">Legislative Office</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Leisure & Travel">
                                                                    <label for="">Leisure & Travel</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Libraries">
                                                                    <label for="">Libraries</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Logistics & Supply Chain">
                                                                    <label for="">Logistics & Supply Chain</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Luxury Goods & Jewelry">
                                                                    <label for="">Luxury Goods & Jewelry</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Machinery">
                                                                    <label for="">Machinery</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Management Consulting">
                                                                    <label for="">Management Consulting</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Maritime">
                                                                    <label for="">Maritime</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Marketing & Advertising">
                                                                    <label for="">Marketing & Advertising</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Market Research">
                                                                    <label for="">Market Research</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Mechanical or Industrial Engineering">
                                                                    <label for="">Mechanical or Industrial Engineering</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Media Production">
                                                                    <label for="">Media Production</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Medical Device">
                                                                    <label for="">Medical Device</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Medical Practice">
                                                                    <label for="">Medical Practice</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Mental Health Care">
                                                                    <label for="">Mental Health Care</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Military">
                                                                    <label for="">Military</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Mining & Metals">
                                                                    <label for="">Mining & Metals</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Motion Pictures & Film">
                                                                    <label for="">Motion Pictures & Film</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Museums & Institutions">
                                                                    <label for="">Museums & Institutions</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Music">
                                                                    <label for="">Music</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Nanotechnology">
                                                                    <label for="">Nanotechnology</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Newspapers">
                                                                    <label for="">Newspapers</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Nonprofit Organization Management">
                                                                    <label for="">Nonprofit Organization Management</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Oil & Energy">
                                                                    <label for="">Oil & Energy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Online Publishing">
                                                                    <label for="">Online Publishing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Outsourcing/Offshoring">
                                                                    <label for="">Outsourcing/Offshoring</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Package/Freight Delivery">
                                                                    <label for="">Package/Freight Delivery</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Packaging & Containers">
                                                                    <label for="">Packaging & Containers</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Paper & Forest Products">
                                                                    <label for="">Paper & Forest Products</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Performing Arts">
                                                                    <label for="">Performing Arts</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Pharmaceuticals">
                                                                    <label for="">Pharmaceuticals</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Philanthropy">
                                                                    <label for="">Philanthropy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Photography">
                                                                    <label for="">Photography</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Plastics">
                                                                    <label for="">Plastics</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Political Organization">
                                                                    <label for="">Political Organization</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Primary/Secondary Education">
                                                                    <label for="">Primary/Secondary Education</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Printing">
                                                                    <label for="">Printing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Professional Training">
                                                                    <label for="">Professional Training</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Program Development">
                                                                    <label for="">Program Development</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Public Policy">
                                                                    <label for="">Public Policy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Public Relations">
                                                                    <label for="">Public Relations</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Public Safety">
                                                                    <label for="">Public Safety</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Publishing">
                                                                    <label for="">Publishing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Railroad Manufacture">
                                                                    <label for="">Railroad Manufacture</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Ranching">
                                                                    <label for="">Ranching</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Real Estate">
                                                                    <label for="">Real Estate</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Recreational">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Religious Institutions">
                                                                    <label for="">Religious Institutions</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Renewables & Environment">
                                                                    <label for="">Renewables & Environment</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Research">
                                                                    <label for="">Research</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Restaurants">
                                                                    <label for="">Restaurants</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Retail">
                                                                    <label for="">Retail</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Security & Investigations">
                                                                    <label for="">Security & Investigations</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Semiconductors">
                                                                    <label for="">Semiconductors</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Shipbuilding">
                                                                    <label for="">Shipbuilding</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Sporting Goods">
                                                                    <label for="">Sporting Goods</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Sports">
                                                                    <label for="">Sports</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Staffing & Recruiting">
                                                                    <label for="">Staffing & Recruiting</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Supermarkets">
                                                                    <label for="">Supermarkets</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Telecommunications">
                                                                    <label for="">Telecommunications</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Textiles">
                                                                    <label for="">Textiles</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Think Tanks">
                                                                    <label for="">Think Tanks</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Tobacco">
                                                                    <label for="">Tobacco</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Translation & Localization">
                                                                    <label for="">Translation & Localization</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Transportation/Trucking/Railroad">
                                                                    <label for="">Transportation/Trucking/Railroad</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Utilities">
                                                                    <label for="">Utilities</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Venture Capital">
                                                                    <label for="">Venture Capital</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Veterinary">
                                                                    <label for="">Veterinary</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Warehousing">
                                                                    <label for="">Warehousing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Wholesale">
                                                                    <label for="">Wholesale</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Wine & Spirits">
                                                                    <label for="">Wine & Spirits</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Wireless">
                                                                    <label for="">Wireless</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Writing & Editing">
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" value="Submit" class="btn btn-primary healthCareBtn" name="healthCareBtn">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal fade" id="company" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="healthCare" value="Company" >
                                                    <input type="hidden" name="healthCategory" value="Health" >
                                                    <div class="row">
                                                        <div class="col-sm-1"></div>
                                                        <div class="col-sm-11">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="healthTechno[]" placeholder ="Please, Type companies name max 2000 entries" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <input type="submit" name="healthCareBtn" value="Submit">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <div id="jobLevel" class="modal fade" role='dialog'>
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="POST">
                                                <input type="hidden" name="healthCare" value="Job-Level" >
                                                <input type="hidden" name="healthCategory" value="Health" >
                                                <div class="modal-body">
                                                    <div class="main-order-item">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv">
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' value='CMO'>
                                                                            <label for='clevel-6'>CMO</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]'  value='COO'>
                                                                            <label for='clevel-7'>COO</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]'  value='CTO'>
                                                                            <label for='clevel-8'>CTO</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]'  value='Chairman'>
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' value='Founder'>
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' value='Investor'>
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' value='Owner'>
                                                                            <label for='clevel-17'>Owner</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' value='Partner'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="VP-Level">
                                                                    <label for="">VP-Level</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Director">
                                                                    <label for="">Director</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Manager">
                                                                    <label for="">Manager</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Non-Manager">
                                                                    <label for="">Non-Manager</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Top-Management">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_2(this);" />
                                                                    <label for="" id="myLabel-2">Top-Management</label>
                                                                    <div id="myDiv-2">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='top-1' value='Top Management'>
                                                                            <label for='top-1'>Top Management</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='top-2' value='Deputy'>
                                                                            <label for='top-2'>Deputy</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Business">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_3(this);" />
                                                                    <label for="" id="myLabel-3">Business Development</label>
                                                                    <div id="myDiv-3">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-1'
                                                                                   value='Business Development'>
                                                                            <label for='business-1'>Business Development</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-2'
                                                                                   value='Marketing'>
                                                                            <label for='business-2'>Marketing</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-3' value='Sales'>
                                                                            <label for='business-3'>Sales</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-4'
                                                                                   value='Sales Marketing'>
                                                                            <label for='business-4'>Sales Marketing</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-5'
                                                                                   value='Commercial'>
                                                                            <label for='business-5'>Commercial</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-6'
                                                                                   value='Wholesale-Retail'>
                                                                            <label for='business-6'>Wholesale-Retail</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='business-7'
                                                                                   value='Strategy'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Engineering">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_4(this);" />
                                                                    <label for="" id="myLabel-4">Engineering</label>
                                                                    <div id="myDiv-4">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-1'
                                                                                   value='Engineering'>
                                                                            <label for='engineering-1'>Engineering</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-2'
                                                                                   value='Design'>
                                                                            <label for='engineering-2'>Design</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-3'
                                                                                   value='Research and Development'>
                                                                            <label for='engineering-3'>Research and Development</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-4'
                                                                                   value='Project'>
                                                                            <label for='engineering-4'>Project</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-5'
                                                                                   value='Technical'>
                                                                            <label for='engineering-5'>Technical</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-6'
                                                                                   value='Test'>
                                                                            <label for='engineering-6'>Test</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='engineering-7'
                                                                                   value='Chemical'>
                                                                            <label for='engineering-7'>Chemical</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class='form-group'>
                                                                        <input type='checkbox' name='healthTechno[]' id='engineering-8'
                                                                               value='Chemist'>
                                                                        <label for='engineering-8'>Chemist</label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Government">
                                                                    <label for="">Government</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Accountant">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_5(this);" />
                                                                    <label for="" id="myLabel-5">Accountant</label>
                                                                    <div id="myDiv-5">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='accountant-1'
                                                                                   value='Accountant'>
                                                                            <label for='accountant-1'>Accountant</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='accountant-2'
                                                                                   value='CPA'>
                                                                            <label for='accountant-2'>CPA</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='accountant-3'
                                                                                   value='Bookkeeper'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Architect">
                                                                    <label for="">Architect</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Attorney">
                                                                    <label for="">Attorney</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Audit">
                                                                    <label for="">Audit</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Facilities">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_6(this);" />
                                                                    <label for="" id="myLabel-6">Facilities</label>
                                                                    <div id="myDiv-6">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='facilities-1'
                                                                                   value='Facilities'>
                                                                            <label for='facilities-1'>Facilities</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='facilities-2'
                                                                                   value='Maintenance'>
                                                                            <label for='facilities-2'>Maintenance</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='facilities-3'
                                                                                   value='Safety'>
                                                                            <label for='facilities-3'>Safety</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='facilities-4'
                                                                                   value='Transportation'>
                                                                            <label for='facilities-4'>Transportation</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='facilities-5'
                                                                                   value='Security'>
                                                                            <label for='facilities-5'>Security</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='facilities-6'
                                                                                   value='Real Estate'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Financing">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_7(this);" />
                                                                    <label for="" id="myLabel-7">Financing</label>
                                                                    <div id="myDiv-7">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-1'
                                                                                   value='Financing'>
                                                                            <label for='financing-1'>Financing</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-2'
                                                                                   value='Controlling'>
                                                                            <label for='financing-2'>Controlling</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-3'
                                                                                   value='Credit'>
                                                                            <label for='financing-3'>Credit</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-4'
                                                                                   value='Accounting'>
                                                                            <label for='financing-4'>Accounting</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-5' value='Risk'>
                                                                            <label for='financing-5'>Risk</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-6'
                                                                                   value='Treasurer'>
                                                                            <label for='financing-6'>Treasurer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-7'
                                                                                   value='Controller'>
                                                                            <label for='financing-7'>Controller</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='financing-8'
                                                                                   value='Comptroller'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Creative">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_8(this);" />
                                                                    <label for="" id="myLabel-8">Creative</label>
                                                                    <div id="myDiv-8">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='creative-1'
                                                                                   value='Creative'>
                                                                            <label for='creative-1'>Creative</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='creative-2'
                                                                                   value='Art Director'>
                                                                            <label for='creative-2'>Art Director</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='creative-3'
                                                                                   value='Creative Director'>
                                                                            <label for='creative-3'>Creative Director</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='creative-4'
                                                                                   value='Photographer'>
                                                                            <label for='creative-4'>Photographer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='creative-5'
                                                                                   value='Content'>
                                                                            <label for='creative-5'>Content</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='creative-6'
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Education">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_9(this);" />
                                                                    <label for="" id="myLabel-9">Education</label>
                                                                    <div id="myDiv-9">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-1'
                                                                                   value='Education'>
                                                                            <label for='education-1'>Education</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-2'
                                                                                   value='Teacher'>
                                                                            <label for='education-2'>Teacher</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-3'
                                                                                   value='Elementary Teacher'>
                                                                            <label for='education-3'>Elementary Teacher</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-4'
                                                                                   value='Math Teacher'>
                                                                            <label for='education-4'>Math Teacher</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-5'
                                                                                   value='English Teacher'>
                                                                            <label for='education-5'>English Teacher</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-6'
                                                                                   value='K12 Teacher'>
                                                                            <label for='education-6'>K12 Teacher</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-7'
                                                                                   value='Instructor'>
                                                                            <label for='education-7'>Instructor</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-8'
                                                                                   value='Lecturer'>
                                                                            <label for='education-8'>Lecturer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-9' value='Dean'>
                                                                            <label for='education-9'>Dean</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-10'
                                                                                   value='Academic'>
                                                                            <label for='education-10'>Academic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-11'
                                                                                   value='Alumni'>
                                                                            <label for='education-11'>Alumni</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='education-12'
                                                                                   value='Student'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="HR">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_10(this);" />
                                                                    <label for="" id="myLabel-10">HR</label>
                                                                    <div id="myDiv-10">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='hr-1' value='HR'>
                                                                            <label for='hr-1'>HR</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='hr-2' value='Administration'>
                                                                            <label for='hr-2'>Administration</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='hr-3' value='Payroll'>
                                                                            <label for='hr-3'>Payroll</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='hr-4' value='Training'>
                                                                            <label for='hr-4'>Training</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='hr-5' value='Personnel'>
                                                                            <label for='hr-5'>Personnel</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Principal">
                                                                    <label for="">Principal</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Production">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_11(this);" />
                                                                    <label for="" id="myLabel-11">Production</label>
                                                                    <div id="myDiv-11">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-1'
                                                                                   value='Production'>
                                                                            <label for='production-1'>Production</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-2'
                                                                                   value='Manufacture'>
                                                                            <label for='production-2'>Manufacture</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-3'
                                                                                   value='Operation'>
                                                                            <label for='production-3'>Operation</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-4'
                                                                                   value='Construction'>
                                                                            <label for='production-4'>Construction</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-5'
                                                                                   value='Plant'>
                                                                            <label for='production-5'>Plant</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-6'
                                                                                   value='Logistics'>
                                                                            <label for='production-6'>Logistics</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='production-7'
                                                                                   value='Warehouse'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Professor">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_12(this);" />
                                                                    <label for="" id="myLabel-12">Professor</label>
                                                                    <div id="myDiv-12">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-1'
                                                                                   value='Public Relation'>
                                                                            <label for='professor-1'>Public Relation</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-2'
                                                                                   value='Public Relation'>
                                                                            <label for='professor-2'>Public Relation</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-3'
                                                                                   value='Admission'>
                                                                            <label for='professor-3'>Admission</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-4'
                                                                                   value='Customer Service'>
                                                                            <label for='professor-4'>Customer Service</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-5'
                                                                                   value='Communication'>
                                                                            <label for='professor-5'>Communication</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-6'
                                                                                   value='Media'>
                                                                            <label for='professor-6'>Media</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-7'
                                                                                   value='Publishing'>
                                                                            <label for='professor-7'>Publishing</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='professor-8'
                                                                                   value='Social Media'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Purchasing">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_13(this);" />
                                                                    <label for="" id="myLabel-13">Purchasing</label>
                                                                    <div id="myDiv-13">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='purchasing-1'
                                                                                   value='Purchasing'>
                                                                            <label for='purchasing-1'>Purchasing</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='purchasing-2'
                                                                                   value='Supply Chain'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Quality">
                                                                    <label for="">Quality</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Religious">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_14(this);" />
                                                                    <label for="" id="myLabel-14">Religious</label>
                                                                    <div id="myDiv-14">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-1'
                                                                                   value='Religious'>
                                                                            <label for='religious-1'>Religious</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-2'
                                                                                   value='Bishop'>
                                                                            <label for='religious-2'>Bishop</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-3'
                                                                                   value='Deacon'>
                                                                            <label for='religious-3'>Deacon</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-4'
                                                                                   value='Cardinal'>
                                                                            <label for='religious-4'>Cardinal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-5'
                                                                                   value='Pastor'>
                                                                            <label for='religious-5'>Pastor</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-6'
                                                                                   value='Priest'>
                                                                            <label for='religious-6'>Priest</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='religious-7'
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Superintendent">
                                                                    <label for="">Superintendent</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Support">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_15(this);" />
                                                                    <label for="" id="myLabel-15">Support</label>
                                                                    <div id="myDiv-15">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='support-1' value='Support'>
                                                                            <label for='support-1'>Support</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='support-2'
                                                                                   value='Other Officer'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Planning">
                                                                    <label for="">Planning</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="IT">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_16(this);" />
                                                                    <label for="" id="myLabel-16">IT</label>
                                                                    <div id="myDiv-16">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='it-1' value='IT'>
                                                                            <label for='it-1'>IT</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='it-2' value='Software'>
                                                                            <label for='it-2'>Software</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='it-3' value='Digital'>
                                                                            <label for='it-3'>Digital</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='it-4' value='Web'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-17">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='import-1' value='Import'>
                                                                            <label for='import-1'>Import</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='import-2' value='Export'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-18">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='insurance-1'
                                                                                   value='Insurance Agent'>
                                                                            <label for='insurance-1'>Insurance Agent</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='insurance-2'
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Legal">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_19(this);" />
                                                                    <label for="" id="myLabel-19">Legal</label>
                                                                    <div id="myDiv-19">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='legal-1' value='Legal'>
                                                                            <label for='legal-1'>Legal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='legal-2' value='Policy'>
                                                                            <label for='legal-2'>Policy</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='legal-3' value='Complianc'>
                                                                            <label for='legal-3'>Complianc</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Medical">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_20(this);" />
                                                                    <label for="" id="myLabel-20">Medical</label>
                                                                    <div id="myDiv-20">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='medical-1' value='Medical'>
                                                                            <label for='medical-1'>Medical</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='medical-2' value='Clinical'>
                                                                            <label for='medical-2'>Clinical</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='medical-3' value='Dental'>
                                                                            <label for='medical-3'>Dental</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class='form-group'>
                                                                        <input type='checkbox' name='healthTechno[]' id='medical-4' value='Laboratory'>
                                                                        <label for='medical-4'>Laboratory</label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Others">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_21(this);" />
                                                                    <label for="" id="myLabel-21">Others</label>
                                                                    <div id="myDiv-21">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-1' value='Coach'>
                                                                            <label for='others-1'>Coach</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-2' value='Contractor'>
                                                                            <label for='others-2'>Contractor</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-3' value='Journalist'>
                                                                            <label for='others-3'>Journalist</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-4' value='Economist'>
                                                                            <label for='others-4'>Economist</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-5' value='Surveyor'>
                                                                            <label for='others-5'>Surveyor</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-6' value='Musician'>
                                                                            <label for='others-6'>Musician</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-7' value='Producer'>
                                                                            <label for='others-7'>Producer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-8' value='Singer'>
                                                                            <label for='others-8'>Singer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-9' value='Songwriter'>
                                                                            <label for='others-9'>Songwriter</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-10' value='DJ'>
                                                                            <label for='others-10'>DJ</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-11'
                                                                                   value='Personal Trainer'>
                                                                            <label for='others-11'>Personal Trainer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-12'
                                                                                   value='Stockbroker'>
                                                                            <label for='others-12'>Stockbroker</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-13'
                                                                                   value='Registrar'>
                                                                            <label for='others-13'>Registrar</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-14'
                                                                                   value='Electrician'>
                                                                            <label for='others-14'>Electrician</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-15'
                                                                                   value='Librarian'>
                                                                            <label for='others-15'>Librarian</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='others-16'
                                                                                   value='Agricultural'>
                                                ...
                                                <div class="modal-footer">
                                                    <input type="submit" value="Submit" class="btn btn-primary" name="healthCareBtn">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="main-order-item">
                                                    <div class="row">
                                                        <div class="col-sm-1"></div>
                                                        <form action="" method="POST">
                                                            <input type="hidden" name="healthCare" value="Country" >
                                                            <input type="hidden" name="healthCategory" value="Health" >
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="United States">
                                                                    <label for="">United States</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Canada">
                                                                    <label for="">Canada</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="United Kingdom">
                                                                    <label for="">United Kingdom</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="namerica">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_22(this);" />
                                                                    <label for="" id="myLabel-22">N. America (Others)</label>
                                                                    <div id="myDiv-22">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-1' value='Bahamas'>
                                                                            <label for='namerica-1'>Bahamas</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-2' value='Barbados'>
                                                                            <label for='namerica-2'>Barbados</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-3' value='Belize'>
                                                                            <label for='namerica-3'>Belize</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-4' value='Bermuda'>
                                                                            <label for='namerica-4'>Bermuda</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-5' value='Cayman Islands'>
                                                                            <label for='namerica-5'>Cayman Islands</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-6' value='Costa Rica'>
                                                                            <label for='namerica-6'>Costa Rica</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-7' value='Dominican Republic'>
                                                                            <label for='namerica-7'>Dominican Republic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-8' value='El Salvador'>
                                                                            <label for='namerica-8'>El Salvador</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-9' value='Greenland'>
                                                                            <label for='namerica-9'>Greenland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-10' value='Grenada'>
                                                                            <label for='namerica-10'>Grenada</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-11' value='Guatemala'>
                                                                            <label for='namerica-11'>Guatemala</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-12' value='Honduras'>
                                                                            <label for='namerica-12'>Honduras</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-13' value='Jamaica'>
                                                                            <label for='namerica-13'>Jamaica</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-14' value='Mexico'>
                                                                            <label for='namerica-14'>Mexico</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-15' value='Netherlands Antilles'>
                                                                            <label for='namerica-15'>Netherlands Antilles</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-16' value='Nicaragua'>
                                                                            <label for='namerica-16'>Nicaragua</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-17' value='Puerto Rico'>
                                                                            <label for='namerica-17'>Puerto Rico</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='namerica-18' value='Trinidad And Tobago'>
                                                                            <label for='namerica-18'>Trinidad And Tobago</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="South America">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_23(this);" />
                                                                    <label for="" id="myLabel-23">South America</label>
                                                                    <div id="myDiv-23">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-1' value='Argentina'>
                                                                            <label for='samerica-1'>Argentina</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-2' value='Bolivia'>
                                                                            <label for='samerica-2'>Bolivia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-3' value='Brazil'>
                                                                            <label for='samerica-3'>Brazil</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-4' value='Chile'>
                                                                            <label for='samerica-4'>Chile</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-5' value='Colombia'>
                                                                            <label for='samerica-5'>Colombia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-6' value='Ecuador'>
                                                                            <label for='samerica-6'>Ecuador</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-7' value='Paraguay'>
                                                                            <label for='samerica-7'>Paraguay</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-8' value='Peru'>
                                                                            <label for='samerica-8'>Peru</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-9' value='Suriname'>
                                                                            <label for='samerica-9'>Suriname</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-10' value='Uruguay'>
                                                                            <label for='samerica-10'>Uruguay</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='samerica-11' value='Venezuela'>
                                                                            <label for='samerica-11'>Venezuela</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Asia">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_24(this);" />
                                                                    <label for="" id="myLabel-24">Asia</label>
                                                                    <div id="myDiv-24">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-1' value='Armenia'>
                                                                            <label for='asia-1'>Armenia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-2' value='Azerbaijan'>
                                                                            <label for='asia-2'>Azerbaijan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-3' value='Bangladesh'>
                                                                            <label for='asia-3'>Bangladesh</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-4' value='China'>
                                                                            <label for='asia-4'>China</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-5' value='Hong Kong'>
                                                                            <label for='asia-5'>Hong Kong</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-6' value='India'>
                                                                            <label for='asia-6'>India</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-7' value='Indonesia'>
                                                                            <label for='asia-7'>Indonesia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-8' value='Japan'>
                                                                            <label for='asia-8'>Japan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-9' value='Kazakhstan'>
                                                                            <label for='asia-9'>Kazakhstan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-10' value='Korea'>
                                                                            <label for='asia-10'>Korea</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-11' value='Malaysia'>
                                                                            <label for='asia-11'>Malaysia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-12' value='Maldives'>
                                                                            <label for='asia-12'>Maldives</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-13' value='Nepal'>
                                                                            <label for='asia-13'>Nepal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-14' value='Pakistan'>
                                                                            <label for='asia-14'>Pakistan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-15' value='Philippines'>
                                                                            <label for='asia-15'>Philippines</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-16' value='Singapore'>
                                                                            <label for='asia-16'>Singapore</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-17' value='Sri Lanka'>
                                                                            <label for='asia-17'>Sri Lanka</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-18' value='Taiwan'>
                                                                            <label for='asia-18'>Taiwan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-19' value='Thailand'>
                                                                            <label for='asia-19'>Thailand</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='asia-20' value='Vietnam'>
                                                                            <label for='asia-20'>Vietnam</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Europe">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_25(this);" />
                                                                    <label for="" id="myLabel-25">Europe</label>
                                                                    <div id="myDiv-25">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-1' value='Albania'>
                                                                            <label for='europe-1'>Albania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-2' value='Austria'>
                                                                            <label for='europe-2'>Austria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-3' value='Belarus'>
                                                                            <label for='europe-3'>Belarus</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-4' value='Belgium'>
                                                                            <label for='europe-4'>Belgium</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-5' value='Bosnia And Herzegovina'>
                                                                            <label for='europe-5'>Bosnia And Herzegovina</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-6' value='Bulgaria'>
                                                                            <label for='europe-6'>Bulgaria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-7' value='Croatia'>
                                                                            <label for='europe-7'>Croatia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-8' value='Cyprus'>
                                                                            <label for='europe-8'>Cyprus</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-8' value='Czech Republic'>
                                                                            <label for='europe-8'>Czech Republic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-9' value='Denmark'>
                                                                            <label for='europe-9'>Denmark</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-10' value='Estonia'>
                                                                            <label for='europe-10'>Estonia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-11' value='Finland'>
                                                                            <label for='europe-11'>Finland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-12' value='France'>
                                                                            <label for='europe-12'>France</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-13' value='Georgia'>
                                                                            <label for='europe-13'>Georgia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-14' value='Germany'>
                                                                            <label for='europe-14'>Germany</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-15' value='Gibraltar'>
                                                                            <label for='europe-15'>Gibraltar</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-16' value='Greece'>
                                                                            <label for='europe-16'>Greece</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-17' value='Hungary'>
                                                                            <label for='europe-17'>Hungary</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-18' value='Iceland'>
                                                                            <label for='europe-18'>Iceland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-19' value='Ireland'>
                                                                            <label for='europe-19'>Ireland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-20' value='Isle Of Man'>
                                                                            <label for='europe-20'>Isle Of Man</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-21' value='Italy'>
                                                                            <label for='europe-21'>Italy</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-22' value='Jersey'>
                                                                            <label for='europe-22'>Jersey</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-23' value='Latvia'>
                                                                            <label for='europe-23'>Latvia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-24' value='Lithuania'>
                                                                            <label for='europe-24'>Lithuania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-25' value='Luxembourg'>
                                                                            <label for='europe-25'>Luxembourg</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-26' value='Macedonia'>
                                                                            <label for='europe-26'>Macedonia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-27' value='Malta'>
                                                                            <label for='europe-27'>Malta</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-28' value='Moldova'>
                                                                            <label for='europe-28'>Moldova</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-29' value='Monaco'>
                                                                            <label for='europe-29'>Monaco</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-30' value='Netherlands'>
                                                                            <label for='europe-30'>Netherlands</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-31' value='Norway'>
                                                                            <label for='europe-31'>Norway</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-32' value='Poland'>
                                                                            <label for='europe-32'>Poland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-33' value='Portugal'>
                                                                            <label for='europe-33'>Portugal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-34' value='Romania'>
                                                                            <label for='europe-34'>Romania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-35' value='Serbia'>
                                                                            <label for='europe-35'>Serbia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-36' value='Slovak Republic'>
                                                                            <label for='europe-36'>Slovak Republic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-37' value='Slovenia'>
                                                                            <label for='europe-37'>Slovenia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-38' value='Spain'>
                                                                            <label for='europe-38'>Spain</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-39' value='Sweden'>
                                                                            <label for='europe-39'>Sweden</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-40' value='Switzerland'>
                                                                            <label for='europe-40'>Switzerland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-41' value='Turkey'>
                                                                            <label for='europe-41'>Turkey</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='europe-42' value='Ukraine'>
                                                                            <label for='europe-42'>Ukraine</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Middle East">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_26(this);" />
                                                                    <label for="" id="myLabel-26">Middle East</label>
                                                                    <div id="myDiv-26">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-1' value='Afghanistan'>
                                                                            <label for='middleeast-1'>Afghanistan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-2' value='Bahrain'>
                                                                            <label for='middleeast-2'>Bahrain</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-3' value='Egypt'>
                                                                            <label for='middleeast-3'>Egypt</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-4' value='Iran'>
                                                                            <label for='middleeast-4'>Iran</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-5' value='Israel'>
                                                                            <label for='middleeast-5'>Israel</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-6' value='Jordan'>
                                                                            <label for='middleeast-6'>Jordan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-7' value='Kuwait'>
                                                                            <label for='middleeast-7'>Kuwait</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-8' value='Lebanon'>
                                                                            <label for='middleeast-8'>Lebanon</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-9' value='Palestinian Territory'>
                                                                            <label for='middleeast-9'>Palestinian Territory</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-10' value='Qatar'>
                                                                            <label for='middleeast-10'>Qatar</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-11' value='Saudi Arabia'>
                                                                            <label for='middleeast-11'>Saudi Arabia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-12' value='Sultanate Of Oman'>
                                                                            <label for='middleeast-12'>Sultanate Of Oman</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-13' value='Syria'>
                                                                            <label for='middleeast-13'>Syria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-14' value='United Arab Emirates'>
                                                                            <label for='middleeast-14'>United Arab Emirates</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='middleeast-15' value='Yemen'>
                                                                            <label for='middleeast-15'>Yemen</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Oceania">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_27(this);" />
                                                                    <label for="" id="myLabel-27">Oceania</label>
                                                                    <div id="myDiv-27">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='oceania-1' value='Australia'>
                                                                            <label for='oceania-1'>Australia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='oceania-2' value='New Zealand'>
                                                                            <label for='oceania-2'>New Zealand</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Africa">
                                                                    <input type="button" class="mybtn" value="+"
                                                                           onclick="return change_28(this);" />
                                                                    <label for="" id="myLabel-28">Africa</label>
                                                                    <div id="myDiv-28">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-1' value='Algeria'>
                                                                            <label for='africa-1'>Algeria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-2' value='Angola'>
                                                                            <label for='africa-2'>Angola</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-3' value='Botswana'>
                                                                            <label for='africa-3'>Botswana</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-4' value="Cote D'ivoire">
                                                                            <label for='africa-4'>Cote D'ivoire</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-5' value='Ghana'>
                                                                            <label for='africa-5'>Ghana</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-6' value='Kenya'>
                                                                            <label for='africa-6'>Kenya</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-7' value='Malawi'>
                                                                            <label for='africa-7'>Malawi</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-8' value='Mauritius'>
                                                                            <label for='africa-8'>Mauritius</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-9' value='Morocco'>
                                                                            <label for='africa-9'>Morocco</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-10' value='Mozambique'>
                                                                            <label for='africa-10'>Mozambique</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-11' value='Namibia'>
                                                                            <label for='africa-11'>Namibia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-12' value='Nigeria'>
                                                                            <label for='africa-12'>Nigeria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-13' value='Rwanda'>
                                                                            <label for='africa-13'>Rwanda</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-14' value='South Africa'>
                                                                            <label for='africa-14'>South Africa</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-15' value='Sudan'>
                                                                            <label for='africa-15'>Sudan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-16' value='Tanzania'>
                                                                            <label for='africa-16'>Tanzania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-17' value='Uganda'>
                                                                            <label for='africa-17'>Uganda</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-18' value='Zambia'>
                                                                            <label for='africa-18'>Zambia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='healthTechno[]' id='africa-19' value='Zimbabwe'>
                                                                            <label for='africa-19'>Zimbabwe</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="healthTechno[]" value="Russian Federation">
                                ...
                                <div class="modal fade" id="range" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="healthCare" value="Employee-Range" >
                                                    <input type="hidden" name="healthCategory" value="Health" >
                                                    <div class="row">
                                                        <div class="col-sm-1"></div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="healthTechno[]" placeholder ="Enter Min Employee Range" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <label for="searchCity">Max Employee Range</label>
                                                                <input type="text" name="healthTechno[]" placeholder ="Enter Max Employee Range" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-1"></div>
                                                    </div>
                                ...
                                <div class="modal fade" id="revenue" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="healthCare" value="Revenue-Range" >
                                                    <input type="hidden" name="healthCategory" value="Health" >
                                                    <div class="row">
                                                        <div class="col-sm-1"></div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="healthTechno[]" placeholder ="Enter Min Revenue Range" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <label for="searchCity">Max Revenue Range</label>
                                                                <input type="text" name="healthTechno[]" placeholder ="Enter Max Revenue Range" class="form-control" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-1"></div>
                                                    </div>
                        ...
                        <div class='form-group'>
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        $allemailCategory = '';
                                                if(isset($_SESSION['selectItemHealth'])){
                                                    foreach($_SESSION['selectItemHealth'] as $key => $item ){
                                                        $id = $item['id'];
                                        ...
                                        <form action="/checkout/step1" method="POST">
                                            <div class="row" style="margin-top:10px; clear: left;"><?php 
                                                ...
                                                <div class="col-sm-4 gap-bottom">
                                                    <input type="text" class="form__control" placeholder="Enter Total Leads" name="totalemail" id="totalemailhealth" required 
                                                           onkeyup="totalEmailHealth(value.this)">
                                                </div>
                                                <div class="col-sm-4 gap-bottom">
                                                    <input type="text" class="form__control" placeholder="Delivery Days" name="deliveryDays" id="deliveryDays" readonly required>
                                                </div>
                                                <div class="col-sm-4 gap-bottom">
                                                    <input type="text" class="form__control" placeholder="E-mail Price" name="price" id="totalpricehealth" onkeyup="totalPriceHealth(value.this)" required>
                                                </div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="emailType" value="Health-Care" >
...
<script>
    function totalEmailHealth() {
        let totalEmail = document.getElementById("totalemailhealth").value;
        let price = 0;
        let days = '';
        ...
        document.getElementById("totalpricehealth").value = Math.ceil(price);
        document.getElementById("deliveryDays").value = days;
    }

    function totalPriceHealth() {
        let totalPrice = document.getElementById("totalpricehealth").value;
        let email = 0;
        let days = '';
        ...
        document.getElementById("totalemailhealth").value = Math.ceil(email);
        document.getElementById("deliveryDays").value = days;
    }
</script>
