            ...
            <div class="box box--info gap-bottom categoryStyle">
                <div class="row" style="text-align: center;">
                    <div class="col-lg-12 gap-bottom-small-tlnd">
                        <h2 class="secondary-title clear-gap-vertical font-medium">Complete Your Order Specific Category for Real Estate Agents</h2>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 40px;">
                <div class="main-title">
                    <h1 style="font-weight: 600; font-size: 25px; color: green;">REAL ESTATE AGENTS</h1>
                </div>
                <hr>
                <div class="col-sm-5">
                    <div class="row">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <form action="" method="POST">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Airlines/Aviation">
                                                                    <label for="">Airlines/Aviation</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Alternative Dispute Resolution">
                                                                    <label for="">Alternative Dispute Resolution</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Alternative Medicine">
                                                                    <label for="">Alternative Medicine</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Animation">
                                                                    <label for="">Animation</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Apparel & Fashion">
                                                                    <label for="">Apparel & Fashion</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Architecture & Planning">
                                                                    <label for="">Architecture & Planning</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Arts & Crafts">
                                                                    <label for="">Arts & Crafts</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Automotive">
                                                                    <label for="">Automotive</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Aviation & Aerospace">
                                                                    <label for="">Aviation & Aerospace</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Banking">
                                                                    <label for="">Banking</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="BiorealEstateTechnology">
                                                                    <label for="">BiorealEstateTechnology</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Broadcast Media">
                                                                    <label for="">Broadcast Media</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Building Materials">
                                                                    <label for="">Building Materials</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Business Supplies & Equipment">
                                                                    <label for="">Business Supplies & Equipment</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Capital Markets">
                                                                    <label for="">Capital Markets</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Chemicals">
                                                                    <label for="">Chemicals</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Civic & Social Organization">
                                                                    <label for="">Civic & Social Organization</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Civil Engineering">
                                                                    <label for="">Civil Engineering</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Commercial Real Estate">
                                                                    <label for="">Commercial Real Estate</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Computer & Network Security">
                                                                    <label for="">Computer & Network Security</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Computer Games">
                                                                    <label for="">Computer Games</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Computer Hardware">
                                                                    <label for="">Computer Hardware</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Computer Networking">
                                                                    <label for="">Computer Networking</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Computer Software">
                                                                    <label for="">Computer Software</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Construction">
                                                                    <label for="">Construction</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Consumer Electronics">
                                                                    <label for="">Consumer Electronics</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Consumer Goods">
                                                                    <label for="">Consumer Goods</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Consumer Services">
                                                                    <label for="">Consumer Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Cosmetics">
                                                                    <label for="">Cosmetics</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Dairy">
                                                                    <label for="">Dairy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Defense & Space">
                                                                    <label for="">Defense & Space</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Design">
                                                                    <label for="">Design</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Education Management">
                                                                    <label for="">Education Management</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="E-learning">
                                                                    <label for="">E-learning</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Electrical & Electronic Manufacturing">
                                                                    <label for="">Electrical & Electronic Manufacturing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Entertainment">
                                                                    <label for="">Entertainment</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Environmental Services">
                                                                    <label for="">Environmental Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Events Services">
                                                                    <label for="">Events Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Executive Office">
                                                                    <label for="">Executive Office</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Facilities Services">
                                                                    <label for="">Facilities Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Farming">
                                                                    <label for="">Farming</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Financial Services">
                                                                    <label for="">Financial Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Fine Art">
                                                                    <label for="">Fine Art</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Fishery">
                                                                    <label for="">Fishery</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Food & Beverages">
                                                                    <label for="">Food & Beverages</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Food Production">
                                                                    <label for="">Food Production</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Fundraising">
                                                                    <label for="">Fundraising</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Furniture">
                                                                    <label for="">Furniture</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Gambling & Casinos">
                                                                    <label for="">Gambling & Casinos</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Glass, Ceramics & Concrete">
                                                                    <label for="">Glass, Ceramics & Concrete</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Government Administration">
                                                                    <label for="">Government Administration</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Government Relations">
                                                                    <label for="">Government Relations</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Graphic Design">
                                                                    <label for="">Graphic Design</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Health, Wellness & Fitness">
                                                                    <label for="">Health, Wellness & Fitness</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Higher Education">
                                                                    <label for="">Higher Education</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Hospital & Health Care">
                                                                    <label for="">Hospital & Health Care</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Hospitality">
                                                                    <label for="">Hospitality</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Human Resources">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Individual & Family Services">
                                                                    <label for="">Individual & Family Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Industrial Automation">
                                                                    <label for="">Industrial Automation</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Information Services">
                                                                    <label for="">Information Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Information realEstateTechnology & Services">
                                                                    <label for="">Information realEstateTechnology & Services</label>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="International Affairs">
                                                                    <label for="">International Affairs</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="International Trade & Development">
                                                                    <label for="">International Trade & Development</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Internet">
                                                                    <label for="">Internet</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Investment Banking/Venture">
                                                                    <label for="">Investment Banking/Venture</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Investment Management">
                                                                    <label for="">Investment Management</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Judiciary">
                                                                    <label for="">Judiciary</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Law Enforcement">
                                                                    <label for="">Law Enforcement</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Law Practice">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Legislative Office">
                                                                    <label for="">Legislative Office</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Leisure & Travel">
                                                                    <label for="">Leisure & Travel</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Libraries">
                                                                    <label for="">Libraries</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Logistics & Supply Chain">
                                                                    <label for="">Logistics & Supply Chain</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Luxury Goods & Jewelry">
                                                                    <label for="">Luxury Goods & Jewelry</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Machinery">
                                                                    <label for="">Machinery</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Management Consulting">
                                                                    <label for="">Management Consulting</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Maritime">
                                                                    <label for="">Maritime</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Marketing & Advertising">
                                                                    <label for="">Marketing & Advertising</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Market Research">
                                                                    <label for="">Market Research</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Mechanical or Industrial Engineering">
                                                                    <label for="">Mechanical or Industrial Engineering</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Media Production">
                                                                    <label for="">Media Production</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Medical Device">
                                                                    <label for="">Medical Device</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Medical Practice">
                                                                    <label for="">Medical Practice</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Mental Health Care">
                                                                    <label for="">Mental Health Care</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Military">
                                                                    <label for="">Military</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Mining & Metals">
                                                                    <label for="">Mining & Metals</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Motion Pictures & Film">
                                                                    <label for="">Motion Pictures & Film</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Museums & Institutions">
                                                                    <label for="">Museums & Institutions</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Music">
                                                                    <label for="">Music</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="NanorealEstateTechnology">
                                                                    <label for="">NanorealEstateTechnology</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Newspapers">
                                                                    <label for="">Newspapers</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Nonprofit Organization Management">
                                                                    <label for="">Nonprofit Organization Management</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Oil & Energy">
                                                                    <label for="">Oil & Energy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Online Publishing">
                                                                    <label for="">Online Publishing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Outsourcing/Offshoring">
                                                                    <label for="">Outsourcing/Offshoring</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Package/Freight Delivery">
                                                                    <label for="">Package/Freight Delivery</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Packaging & Containers">
                                                                    <label for="">Packaging & Containers</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Paper & Forest Products">
                                                                    <label for="">Paper & Forest Products</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Performing Arts">
                                                                    <label for="">Performing Arts</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Pharmaceuticals">
                                                                    <label for="">Pharmaceuticals</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Philanthropy">
                                                                    <label for="">Philanthropy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Photography">
                                                                    <label for="">Photography</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Plastics">
                                                                    <label for="">Plastics</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Political Organization">
                                                                    <label for="">Political Organization</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Primary/Secondary Education">
                                                                    <label for="">Primary/Secondary Education</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Printing">
                                                                    <label for="">Printing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Professional Training">
                                                                    <label for="">Professional Training</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Program Development">
                                                                    <label for="">Program Development</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Public Policy">
                                                                    <label for="">Public Policy</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Public Relations">
                                                                    <label for="">Public Relations</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Public Safety">
                                                                    <label for="">Public Safety</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Publishing">
                                                                    <label for="">Publishing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Railroad Manufacture">
                                                                    <label for="">Railroad Manufacture</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Ranching">
                                                                    <label for="">Ranching</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Real Estate">
                                                                    <label for="">Real Estate</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Recreational">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Religious Institutions">
                                                                    <label for="">Religious Institutions</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Renewables & Environment">
                                                                    <label for="">Renewables & Environment</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Research">
                                                                    <label for="">Research</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Restaurants">
                                                                    <label for="">Restaurants</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Retail">
                                                                    <label for="">Retail</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Security & Investigations">
                                                                    <label for="">Security & Investigations</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Semiconductors">
                                                                    <label for="">Semiconductors</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Shipbuilding">
                                                                    <label for="">Shipbuilding</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Sporting Goods">
                                                                    <label for="">Sporting Goods</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Sports">
                                                                    <label for="">Sports</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Staffing & Recruiting">
                                                                    <label for="">Staffing & Recruiting</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Supermarkets">
                                                                    <label for="">Supermarkets</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Telecommunications">
                                                                    <label for="">Telecommunications</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Textiles">
                                                                    <label for="">Textiles</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Think Tanks">
                                                                    <label for="">Think Tanks</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Tobacco">
                                                                    <label for="">Tobacco</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Translation & Localization">
                                                                    <label for="">Translation & Localization</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Transportation/Trucking/Railroad">
                                                                    <label for="">Transportation/Trucking/Railroad</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Utilities">
                                                                    <label for="">Utilities</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Venture Capital">
                                                                    <label for="">Venture Capital</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Veterinary">
                                                                    <label for="">Veterinary</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Warehousing">
                                                                    <label for="">Warehousing</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Wholesale">
                                                                    <label for="">Wholesale</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Wine & Spirits">
                                                                    <label for="">Wine & Spirits</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Wireless">
                                                                    <label for="">Wireless</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Writing & Editing">
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" value="Submit" class="btn btn-primary" name="realEstateBtn">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <input type="submit" name="realEstateBtn" value="Submit">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                                ...
                                                <div class="modal-body">
                                                    <div class="main-order-item">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="C-Level">
                                                                    ...
                                                                    <div id="myDiv">
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' value='CMO'>
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' value='Founder'>
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' value='Investor'>
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' value='Owner'>
                                                                            <label for='clevel-17'>Owner</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' value='Partner'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="VP-Level">
                                                                    <label for="">VP-Level</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Director">
                                                                    <label for="">Director</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Manager">
                                                                    <label for="">Manager</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Non-Manager">
                                                                    <label for="">Non-Manager</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Top-Management">
                                                                    <input type="button" class="mybtn" value="+" onclick="return change_2(this);" />
                                                                    <label for="" id="myLabel-2">Top-Management</label>
                                                                    <div id="myDiv-2">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='top-1' value='Top Management'>
                                                                            <label for='top-1'>Top Management</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='top-2' value='Deputy'>
                                                                            <label for='top-2'>Deputy</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Business">
                                                                    ...
                                                                    <div id="myDiv-3">
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='business-3' value='Sales'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Engineering">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Government">
                                                                    <label for="">Government</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Accountant">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Architect">
                                                                    <label for="">Architect</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Attorney">
                                                                    <label for="">Attorney</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Audit">
                                                                    <label for="">Audit</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Facilities">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Financing">
                                                                    ...
                                                                    <div id="myDiv-7">
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='financing-5' value='Risk'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Creative">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Education">
                                                                    ...
                                                                    <div id="myDiv-9">
                                                                        ...
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='education-9' value='Dean'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-10">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='hr-1' value='HR'>
                                                                            <label for='hr-1'>HR</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='hr-2' value='Administration'>
                                                                            <label for='hr-2'>Administration</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='hr-3' value='Payroll'>
                                                                            <label for='hr-3'>Payroll</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='hr-4' value='Training'>
                                                                            <label for='hr-4'>Training</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='hr-5' value='Personnel'>
                                                                            <label for='hr-5'>Personnel</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Principal">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Quality">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Superintendent">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-15">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='support-1' value='Support'>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Planning">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-16">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='it-1' value='IT'>
                                                                            <label for='it-1'>IT</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='it-2' value='Software'>
                                                                            <label for='it-2'>Software</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='it-3' value='Digital'>
                                                                            <label for='it-3'>Digital</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='it-4' value='Web'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-17">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='import-1' value='Import'>
                                                                            <label for='import-1'>Import</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='import-2' value='Export'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-19">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='legal-1' value='Legal'>
                                                                            <label for='legal-1'>Legal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='legal-2' value='Policy'>
                                                                            <label for='legal-2'>Policy</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='legal-3' value='Complianc'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-20">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='medical-1' value='Medical'>
                                                                            <label for='medical-1'>Medical</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='medical-2' value='Clinical'>
                                                                            <label for='medical-2'>Clinical</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='medical-3' value='Dental'>
                                                                            <label for='medical-3'>Dental</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class='form-group'>
                                                                        <input type='checkbox' name='realEstateTechno[]' id='medical-4' value='Laboratory'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-21">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-1' value='Coach'>
                                                                            <label for='others-1'>Coach</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-2' value='Contractor'>
                                                                            <label for='others-2'>Contractor</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-3' value='Journalist'>
                                                                            <label for='others-3'>Journalist</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-4' value='Economist'>
                                                                            <label for='others-4'>Economist</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-5' value='Surveyor'>
                                                                            <label for='others-5'>Surveyor</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-6' value='Musician'>
                                                                            <label for='others-6'>Musician</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-7' value='Producer'>
                                                                            <label for='others-7'>Producer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-8' value='Singer'>
                                                                            <label for='others-8'>Singer</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-9' value='Songwriter'>
                                                                            <label for='others-9'>Songwriter</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='others-10' value='DJ'>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <form action="" method="POST">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Canada">
                                                                    <label for="">Canada</label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="United Kingdom">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-22">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-1' value='Bahamas'>
                                                                            <label for='namerica-1'>Bahamas</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-2' value='Barbados'>
                                                                            <label for='namerica-2'>Barbados</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-3' value='Belize'>
                                                                            <label for='namerica-3'>Belize</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-4' value='Bermuda'>
                                                                            <label for='namerica-4'>Bermuda</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-5' value='Cayman Islands'>
                                                                            <label for='namerica-5'>Cayman Islands</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-6' value='Costa Rica'>
                                                                            <label for='namerica-6'>Costa Rica</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-7' value='Dominican Republic'>
                                                                            <label for='namerica-7'>Dominican Republic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-8' value='El Salvador'>
                                                                            <label for='namerica-8'>El Salvador</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-9' value='Greenland'>
                                                                            <label for='namerica-9'>Greenland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-10' value='Grenada'>
                                                                            <label for='namerica-10'>Grenada</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-11' value='Guatemala'>
                                                                            <label for='namerica-11'>Guatemala</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-12' value='Honduras'>
                                                                            <label for='namerica-12'>Honduras</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-13' value='Jamaica'>
                                                                            <label for='namerica-13'>Jamaica</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-14' value='Mexico'>
                                                                            <label for='namerica-14'>Mexico</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-15' value='Netherlands Antilles'>
                                                                            <label for='namerica-15'>Netherlands Antilles</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-16' value='Nicaragua'>
                                                                            <label for='namerica-16'>Nicaragua</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-17' value='Puerto Rico'>
                                                                            <label for='namerica-17'>Puerto Rico</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='namerica-18' value='Trinidad And Tobago'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-23">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-1' value='Argentina'>
                                                                            <label for='samerica-1'>Argentina</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-2' value='Bolivia'>
                                                                            <label for='samerica-2'>Bolivia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-3' value='Brazil'>
                                                                            <label for='samerica-3'>Brazil</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-4' value='Chile'>
                                                                            <label for='samerica-4'>Chile</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-5' value='Colombia'>
                                                                            <label for='samerica-5'>Colombia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-6' value='Ecuador'>
                                                                            <label for='samerica-6'>Ecuador</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-7' value='Paraguay'>
                                                                            <label for='samerica-7'>Paraguay</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-8' value='Peru'>
                                                                            <label for='samerica-8'>Peru</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-9' value='Suriname'>
                                                                            <label for='samerica-9'>Suriname</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-10' value='Uruguay'>
                                                                            <label for='samerica-10'>Uruguay</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='samerica-11' value='Venezuela'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-24">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-1' value='Armenia'>
                                                                            <label for='asia-1'>Armenia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-2' value='Azerbaijan'>
                                                                            <label for='asia-2'>Azerbaijan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-3' value='Bangladesh'>
                                                                            <label for='asia-3'>Bangladesh</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-4' value='China'>
                                                                            <label for='asia-4'>China</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-5' value='Hong Kong'>
                                                                            <label for='asia-5'>Hong Kong</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-6' value='India'>
                                                                            <label for='asia-6'>India</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-7' value='Indonesia'>
                                                                            <label for='asia-7'>Indonesia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-8' value='Japan'>
                                                                            <label for='asia-8'>Japan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-9' value='Kazakhstan'>
                                                                            <label for='asia-9'>Kazakhstan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-10' value='Korea'>
                                                                            <label for='asia-10'>Korea</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-11' value='Malaysia'>
                                                                            <label for='asia-11'>Malaysia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-12' value='Maldives'>
                                                                            <label for='asia-12'>Maldives</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-13' value='Nepal'>
                                                                            <label for='asia-13'>Nepal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-14' value='Pakistan'>
                                                                            <label for='asia-14'>Pakistan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-15' value='Philippines'>
                                                                            <label for='asia-15'>Philippines</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-16' value='Singapore'>
                                                                            <label for='asia-16'>Singapore</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-17' value='Sri Lanka'>
                                                                            <label for='asia-17'>Sri Lanka</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-18' value='Taiwan'>
                                                                            <label for='asia-18'>Taiwan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-19' value='Thailand'>
                                                                            <label for='asia-19'>Thailand</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='asia-20' value='Vietnam'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-25">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-1' value='Albania'>
                                                                            <label for='europe-1'>Albania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-2' value='Austria'>
                                                                            <label for='europe-2'>Austria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-3' value='Belarus'>
                                                                            <label for='europe-3'>Belarus</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-4' value='Belgium'>
                                                                            <label for='europe-4'>Belgium</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-5' value='Bosnia And Herzegovina'>
                                                                            <label for='europe-5'>Bosnia And Herzegovina</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-6' value='Bulgaria'>
                                                                            <label for='europe-6'>Bulgaria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-7' value='Croatia'>
                                                                            <label for='europe-7'>Croatia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-8' value='Cyprus'>
                                                                            <label for='europe-8'>Cyprus</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-8' value='Czech Republic'>
                                                                            <label for='europe-8'>Czech Republic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-9' value='Denmark'>
                                                                            <label for='europe-9'>Denmark</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-10' value='Estonia'>
                                                                            <label for='europe-10'>Estonia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-11' value='Finland'>
                                                                            <label for='europe-11'>Finland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-12' value='France'>
                                                                            <label for='europe-12'>France</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-13' value='Georgia'>
                                                                            <label for='europe-13'>Georgia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-14' value='Germany'>
                                                                            <label for='europe-14'>Germany</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-15' value='Gibraltar'>
                                                                            <label for='europe-15'>Gibraltar</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-16' value='Greece'>
                                                                            <label for='europe-16'>Greece</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-17' value='Hungary'>
                                                                            <label for='europe-17'>Hungary</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-18' value='Iceland'>
                                                                            <label for='europe-18'>Iceland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-19' value='Ireland'>
                                                                            <label for='europe-19'>Ireland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-20' value='Isle Of Man'>
                                                                            <label for='europe-20'>Isle Of Man</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-21' value='Italy'>
                                                                            <label for='europe-21'>Italy</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-22' value='Jersey'>
                                                                            <label for='europe-22'>Jersey</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-23' value='Latvia'>
                                                                            <label for='europe-23'>Latvia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-24' value='Lithuania'>
                                                                            <label for='europe-24'>Lithuania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-25' value='Luxembourg'>
                                                                            <label for='europe-25'>Luxembourg</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-26' value='Macedonia'>
                                                                            <label for='europe-26'>Macedonia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-27' value='Malta'>
                                                                            <label for='europe-27'>Malta</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-28' value='Moldova'>
                                                                            <label for='europe-28'>Moldova</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-29' value='Monaco'>
                                                                            <label for='europe-29'>Monaco</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-30' value='Netherlands'>
                                                                            <label for='europe-30'>Netherlands</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-31' value='Norway'>
                                                                            <label for='europe-31'>Norway</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-32' value='Poland'>
                                                                            <label for='europe-32'>Poland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-33' value='Portugal'>
                                                                            <label for='europe-33'>Portugal</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-34' value='Romania'>
                                                                            <label for='europe-34'>Romania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-35' value='Serbia'>
                                                                            <label for='europe-35'>Serbia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-36' value='Slovak Republic'>
                                                                            <label for='europe-36'>Slovak Republic</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-37' value='Slovenia'>
                                                                            <label for='europe-37'>Slovenia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-38' value='Spain'>
                                                                            <label for='europe-38'>Spain</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-39' value='Sweden'>
                                                                            <label for='europe-39'>Sweden</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-40' value='Switzerland'>
                                                                            <label for='europe-40'>Switzerland</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-41' value='Turkey'>
                                                                            <label for='europe-41'>Turkey</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='europe-42' value='Ukraine'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-26">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-1' value='Afghanistan'>
                                                                            <label for='middleeast-1'>Afghanistan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-2' value='Bahrain'>
                                                                            <label for='middleeast-2'>Bahrain</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-3' value='Egypt'>
                                                                            <label for='middleeast-3'>Egypt</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-4' value='Iran'>
                                                                            <label for='middleeast-4'>Iran</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-5' value='Israel'>
                                                                            <label for='middleeast-5'>Israel</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-6' value='Jordan'>
                                                                            <label for='middleeast-6'>Jordan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-7' value='Kuwait'>
                                                                            <label for='middleeast-7'>Kuwait</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-8' value='Lebanon'>
                                                                            <label for='middleeast-8'>Lebanon</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-9' value='Palestinian Territory'>
                                                                            <label for='middleeast-9'>Palestinian Territory</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-10' value='Qatar'>
                                                                            <label for='middleeast-10'>Qatar</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-11' value='Saudi Arabia'>
                                                                            <label for='middleeast-11'>Saudi Arabia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-12' value='Sultanate Of Oman'>
                                                                            <label for='middleeast-12'>Sultanate Of Oman</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-13' value='Syria'>
                                                                            <label for='middleeast-13'>Syria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-14' value='United Arab Emirates'>
                                                                            <label for='middleeast-14'>United Arab Emirates</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='middleeast-15' value='Yemen'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-27">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='oceania-1' value='Australia'>
                                                                            <label for='oceania-1'>Australia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='oceania-2' value='New Zealand'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="myDiv-28">
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-1' value='Algeria'>
                                                                            <label for='africa-1'>Algeria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-2' value='Angola'>
                                                                            <label for='africa-2'>Angola</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-3' value='Botswana'>
                                                                            <label for='africa-3'>Botswana</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-4' value="Cote D'ivoire">
                                                                            <label for='africa-4'>Cote D'ivoire</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-5' value='Ghana'>
                                                                            <label for='africa-5'>Ghana</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-6' value='Kenya'>
                                                                            <label for='africa-6'>Kenya</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-7' value='Malawi'>
                                                                            <label for='africa-7'>Malawi</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-8' value='Mauritius'>
                                                                            <label for='africa-8'>Mauritius</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-9' value='Morocco'>
                                                                            <label for='africa-9'>Morocco</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-10' value='Mozambique'>
                                                                            <label for='africa-10'>Mozambique</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-11' value='Namibia'>
                                                                            <label for='africa-11'>Namibia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-12' value='Nigeria'>
                                                                            <label for='africa-12'>Nigeria</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-13' value='Rwanda'>
                                                                            <label for='africa-13'>Rwanda</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-14' value='South Africa'>
                                                                            <label for='africa-14'>South Africa</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-15' value='Sudan'>
                                                                            <label for='africa-15'>Sudan</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-16' value='Tanzania'>
                                                                            <label for='africa-16'>Tanzania</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-17' value='Uganda'>
                                                                            <label for='africa-17'>Uganda</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-18' value='Zambia'>
                                                                            <label for='africa-18'>Zambia</label>
                                                                        </div>
                                                                        <div class='form-group'>
                                                                            <input type='checkbox' name='realEstateTechno[]' id='africa-19' value='Zimbabwe'>
                                                                            <label for='africa-19'>Zimbabwe</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="checkbox" name="realEstateTechno[]" value="Russian Federation">
...
<script>
    function totalEmailReal() {
        let totalEmail = document.getElementById("totalemailreal").value;
        let price = 0;
        let days = '';
