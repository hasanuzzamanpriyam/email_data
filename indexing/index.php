...
<body>
    ...
    <footer class="site-footer">
        <div class="container">
            <p class="copyright text-center">Developed by <a href="https://github.com/autocircled" target="_blank">autocircled</a>. Feel free to <a href="mailto:autocircled@gmail.com">contact with me</a> if you need further help or any suggestions about this project.</p>
        </div>
    </footer>
